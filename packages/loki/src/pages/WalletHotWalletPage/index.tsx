...
const WalletHotWalletPage = (props: Props) => {
  ...
  return (
    <>
      <Helmet>
        <title>
          {t('UMO Hot Wallet')} - {APP_NAME}
        </title>
      </Helmet>
      <LayoutContainer header={t('UMO Hot Wallet')} maxWidth={false}>
        <Grid container>
          <Grid item xs={12}>
...
export default WalletHotWalletPage;
