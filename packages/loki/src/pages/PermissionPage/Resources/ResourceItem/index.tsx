...
type ResourceItemProps = {
  item: Resource.AsObject;
  onSelect: (resource: Resource.AsObject) => void;
};

const ResourceItem = ({ item, onSelect }: ResourceItemProps) => {
  ...
  const isCanPermissionUpdate = isLegalPermission(PerformPermission.permissionResource.updateResource, userPermissions);
