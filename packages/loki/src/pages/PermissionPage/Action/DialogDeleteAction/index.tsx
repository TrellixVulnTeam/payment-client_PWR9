...
const useStyles = makeStyles<Theme>((theme) => ({
  ...
  MuiDialogPaperWidthSm: {
    maxWidth: '528px', // DESIGN
  },
}));

type DialogDeleteActionProps = { onClose: () => void; onDelete: (id: string) => void };

const DialogDeleteAction = ({ onClose, onDelete }: DialogDeleteActionProps) => {
  ...
  return (
    <AlopayDialog
      ...
      classes={{ paperWidthSm: classes.MuiDialogPaperWidthSm }}
      actions={
        <>
          <Button
            fullWidth
